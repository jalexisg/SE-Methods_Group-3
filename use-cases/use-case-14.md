# USE CASE: 14 Getting population breakdown by region

## CHARACTERISTIC INFORMATION

### Goal in Context

As a demographic analyst I want to see population breakdown by region (total, urban, rural) So that I can analyze urbanization patterns by region
...
Region Population is displayed and broke down correctly
...
3. System runs a simple query (SELECT region, total, urban, rural FROM world )
